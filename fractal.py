...
class Mandelbrot(Fractal):
    ...
    def generate_tasks(self, smm, num_tasks):
        ...
        lambda_generator = (lambda rows: (lambda: self.row_set_calc(self.horizon, self.iterations, rows, Z, N, C, Q)))
        tasks = [lambda_generator(row_range) for row_range in ranges]
        return tasks, (C, N, Z, Q)
